...
We will create an amazing library called `gimme-a-pokemon`, and we will publish it on npm. The package will provide a function that will return a random pokemon name from an array. (Very useful 🎹)
...
- **name**: The name of the library. _Mandatory_
- **version**: The version of the library. _Mandatory_
- **private**: If the library is private, it will not be available for the public. _Mandatory_
- **main**: The path to the library's main file. _Mandatory_
- **description**: A short description of the library. _Optional_
- **files**: A list of files that will be included in the library. _Optional_
- **author**: The author of the library. _Optional_
- **license**: The license of the library. _Optional_
- **dependencies**: A list of dependencies that the library needs. _Optional_
...
And that's it! The library is published on npm with the version `0.0.1` and you will be able to install it in your project.
